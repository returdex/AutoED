...
- 01-01至01-07已完成：受管依赖、持久任务、原生保护、认证API及显式配对、独立API/Worker、只读状态页、真实CLI/SDK stdio MCP与独立构建清单自检；独立复跑43项单元测试、56项集成测试、9项macOS原生测试、10项Chromium UI测试、类型检查与四入口构建通过。接下来执行01-08受管安装；发行签名信任、完整升级与平台诊断仍待后续验证。
