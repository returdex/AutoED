...
- 01-01至01-05和01-07已完成：受管依赖、持久任务、原生保护、认证API及显式配对、独立API/Worker生命周期、只读状态页；独立复跑42项单元测试、44项集成测试、9项macOS原生测试、10项Chromium UI测试、类型检查与构建通过。接下来执行01-06实际CLI/MCP接线；实际manifest及平台诊断观测仍需后续接线。
