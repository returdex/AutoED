...
- **Reconfirmed on corrected beta.25 source:** After publication preflight exposed exact absent-tag and public-versus-consumed version reconciliation gaps and invalidated unpublished beta.24, the complete selected-source matrix passed freshly: unit `143/143`, integration `346/346`, UI `34/34` and macOS native `24/24`, with typecheck green, zero skip/todo/only invocation and zero four-surface sensitive findings. Earlier entries remain historical execution evidence, not current blockers; beta.21 through beta.24 remain permanently invalidated and are not deferred release debt.
