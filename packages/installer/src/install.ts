...
interface InstallerDependencies {verify?:typeof verifyRelease;store?:SecretStore;acquire?:(manifest:VerifiedManifest,stagingParent:string)=>Promise<Record<string,Buffer>>;execute?:typeof upgradeConfirmed;recover?:typeof recoverUpgrade;resumeCleanup?:typeof resumeCleanupUpgrade}
